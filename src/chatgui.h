...
private:
    ...
    std::unique_ptr<ChatLogic> _chatLogic;  //Making this attribute pointer an exlusive resource to this class (Task 1)
...
public:
    ...
    // getter / setter
    ChatLogic *GetChatLogicHandle() { return _chatLogic.get(); }    //Update for unique pointer (Task 1)
